    ...
    return (
        <div className="w-full h-screen flex flex-row justify-between items-center">
            <div className="w-full h-full col-span-2 flex flex-col ">
                <h1 className="w-4/5 col-span-2 text-black text-6xl ml-5 my-20">Plastic pollution poses significant harm to ecosystems everywhere</h1>
                <p className="w-4/5 h-3/5 border-4 border-black text-4xl ml-5 p-7 text-justify">
